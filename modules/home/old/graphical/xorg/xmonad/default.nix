  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      systemd.user.services = {
        ...
        xmobar = {
          ...
          Service = {
            ExecStart = "${pkgs.xmobar}/bin/xmobar /home/thongpv87/.xmonad/xmobar/doom-one-xmobarrc";
            Restart = "on-failure";
            Slice = "session.slice";
          };
          Install = {
        ...
        trayer = {
          ...
          Service = {
            ExecStart = "${pkgs.trayer}/bin/trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x282c34 --height 22";
            Restart = "on-failure";
            Slice = "session.slice";
          };
          Install = {
        ...
        xsettings = {
          ...
          Service = {
            ExecStart = "${pkgs.gnome-settings-daemon}/libexec/gsd-xsettings";
            Restart = "on-failure";
            RestartSec = 3;
          };
