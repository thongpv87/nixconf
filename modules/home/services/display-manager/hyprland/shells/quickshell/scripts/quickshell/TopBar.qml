...
Variants {
    ...
    property string sysTemp: "0"

    Process {
        id: sysInfoPoller
        command: ["python3", Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/sysinfo/get_sys_info.py"]
        running: true
        stdout: StdioCollector {
            onStreamFinished: {
                try {
                    if (this.text.trim() !== "") {
                        ...
                        barWindow.sysCpu = data.cpu.toString();
                        barWindow.sysRam = data.ram.toString();
                        barWindow.sysTemp = data.temp.toString();
                    }
                } catch(e) {}
            }
        }
            ...
            Item {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        property real targetWidth: visibleTrayCount > 0 ? trayLayout.implicitWidth + barWindow.s(24) : 0
                        width: targetWidth
                        Behavior on width { NumberAnimation { duration: 400; easing.type: Easing.OutExpo } }
                            ...
                            Repeater {
                                ...
                                delegate: Image {
                                    ...
                                    property bool isBlacklisted: {
                                        let text = ((modelData.id || "") + " " + (modelData.title || "") + " " + (modelData.icon || "")).toLowerCase();
                                        return text.indexOf("fcitx") !== -1 || text.indexOf("bamboo") !== -1 || text.indexOf("blueman") !== -1 || text.indexOf("bluetooth") !== -1;
                                    }
                                    ...
                                    sourceSize: visible ? Qt.size(barWindow.s(18), barWindow.s(18)) : Qt.size(0, 0)
                                    width: visible ? barWindow.s(18) : 0
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    gradient: Gradient {
                                        ...
                                        GradientStop { position: 1.0; color: Qt.lighter(mocha.teal, 1.25) }
                                    }
                                }
                                ...
                                Row { 
                                    ...
                                    Row {
                                        spacing: barWindow.s(2.5)
                                        anchors.verticalCenter: parent.verticalCenter
                                        Text { text: ""; font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(14); color: mocha.base }
                                        Text { 
                                    ...
                                    Text { text: "•"; font.pixelSize: barWindow.s(8); color: Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.45); anchors.verticalCenter: parent.verticalCenter }

                                    Row {
                                        spacing: barWindow.s(2.5)
                                        anchors.verticalCenter: parent.verticalCenter
                                        Text { text: "󰍛"; font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(14); color: mocha.base }
                                        Text { 
                                    ...
                                    Row {
                                        ...
                                        Text { 
                                            ...
                                            width: barWindow.s(32); horizontalAlignment: Text.AlignLeft;
                                            font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(12); font.weight: Font.Black; 
                                            color: mocha.base 
                                        }
                                    }
